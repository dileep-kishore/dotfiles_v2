# Generated by Powerlevel10k configuration wizard on 2021-12-21 at 23:38 EST.
...
# 24h time, slanted separators, slanted heads, blurred tails, 2 lines, dotted,
...
() {
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_NUM_CONFLICTED )) && res+=" ${conflicted}ﲅ${VCS_STATUS_NUM_CONFLICTED}"
  ...
  typeset -g POWERLEVEL9K_DIRENV_BACKGROUND=5
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_ASDF_BACKGROUND=5
  ...
  typeset -g POWERLEVEL9K_NNN_BACKGROUND=5
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_XPLR_BACKGROUND=5
  # Custom icon.
