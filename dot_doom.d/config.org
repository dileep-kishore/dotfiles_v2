...
- [[#configuring-private-settings][Configuring private settings]]
  ...
  - [[#org-mode-and-org-roam-directories][Org-mode and Org-roam directories]]
...
** Org-mode and Org-roam directories
...
(after! org
  (setq
   ...
   '(("TODO" :foreground "#7c7c75" :weight normal :underline t)
     ...
     ("WAIT" :foreground "#ff8000" :weight normal :underline t)
     ("DONE" :foreground "#50a14f" :weight normal :underline t)
     ("CANCELLED" :foreground "#ff6480" :weight normal :underline t)))
  (set-face-attribute 'org-link nil :weight 'normal :slant 'italic)
  (set-face-attribute 'org-roam-link nil :slant 'italic :foreground "#00ebc2")
...
(use-package org-pretty-tags
  ...
  (setq org-pretty-tags-surrogate-strings
        `(("OKR"        . ,(all-the-icons-faicon   "rocket"         :face 'all-the-icons-purple  :v-adjust 0.01))
          ("OBJ"        . ,(all-the-icons-faicon   "bullseye"       :face 'all-the-icons-purple  :v-adjust 0.01))
          ("uni"        . ,(all-the-icons-faicon   "graduation-cap" :face 'all-the-icons-purple  :v-adjust 0.01))
          ("code"        . ,(all-the-icons-material "computer"       :face 'all-the-icons-silver  :v-adjust 0.01))
...
(after! org
  ...
  (setq org-todo-keywords '((sequence "TODO(t)" "PROG(p)"  "NEXT(n)" "WAIT(w@/!)" "|" "DONE(d)" "CANCELLED(c)")))
