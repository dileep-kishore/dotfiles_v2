...
#+begin_src elisp
(setq doom-font (font-spec :family "VictorMono Nerd Font" :size 16 :height 1.0)
      doom-variable-pitch-font (font-spec :family "Alegreya" :size 19 :height 1.2)
      doom-unicode-font (font-spec :family "FiraCode Nerd Font" :size 16 :height 1.0)
      doom-serif-font (font-spec :family "BlexMono Nerd Font" :weight 'light :size 16 :height 1.0)
      doom-big-font (font-spec :family "FiraCode Nerd Font" :size 25 :height 1.0))
#+end_src
...
(use-package! mixed-pitch
  ...
  (set-face-attribute 'org-document-title nil
                      :height 1.9
                      :weight 'bold)
  (set-face-attribute 'fixed-pitch nil :height 1.2)
